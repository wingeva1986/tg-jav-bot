...
class BotCacheDb:
    ...
    def __init__(self, host: str, port: int, password: str, password: str, use_cache: str):
        self.use_cache = use_cache
        self.cache = None
        if self.use_cache == "1":
            try:
                self.cache = redis.Redis(host=host, port=port,username="default",password="2b40f7dd4bc54424a61fd694edc394ed")
                self.cache.ping()
